...
export default function AdminLogin() {
  ...
  async function handleOauthAdminCheck(userEmail) {
    ...
    setError('');
    try {
      const data = await apiRequest('/api/auth/admin-oauth', { method: 'POST', body: { email: userEmail } });
    ...
    <main style={pageStyle}>
      <div style={cardStyle}>
        ...
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(212,175,42,0.4)'; e.currentTarget.style.background = 'rgba(212,175,42,0.1)' }}
          onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.12)'; e.currentTarget.style.background = 'linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.02) 100%)' }}
        >
