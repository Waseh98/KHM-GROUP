...
export default function Women() {
  ...
  const womenProducts = getProducts().filter(
    (p) => p.tag === 'Women' || p.name.toLowerCase().includes('women')
  );
    ...
    <main>
      ...
      >
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              'url(https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=1600&q=80)',
      ...
      <section style={{ backgroundColor: 'var(--light-gray)', padding: '80px 0' }}>
        <div className="container">
          ...
          >
            <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '2rem', fontWeight: 600, color: 'var(--black)', margin: 0 }}>
              All Women&apos;s Polos
            </h2>
            <span style={{ fontFamily: 'var(--font-body)', color: 'var(--mid-gray)', fontSize: '0.9rem' }}>
              Showing {womenProducts.length} items
            </span>
          </div>
